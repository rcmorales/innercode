					...
					<div class="row masonry-wrapper">
						<?php 
							//while ( have_posts() ) : the_post();
								//rmorales added different home page sections
								get_template_part( 'template-parts/archive/stats', '' ); 
								get_template_part( 'template-parts/archive/content_feature', '' ); 
								get_template_part( 'template-parts/archive/sect4', '' ); 
								get_template_part( 'template-parts/archive/sect5', '' ); 
								get_template_part( 'template-parts/archive/sect6', '' );
								get_template_part( 'template-parts/archive/home_testimonials', '' );
								get_template_part( 'template-parts/archive/eligibility', '' );	
