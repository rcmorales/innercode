...
function business_gravity_inner_banner(){
	...
	if( is_archive() ){
		...
		$title = business_gravity_get_option( 'archive_page_title' );		$subtitle = business_gravity_get_option( 'archive_page_subtitle' ); #added by rmorales 1/27/2020 for added header text and buttons		$signuptext = business_gravity_get_option( 'archive_button_signuptext' ); #added by rmorales 1/27/2020 for added header text and buttons		$comparetext = business_gravity_get_option( 'archive_button_comparetext' ); #added by rmorales 1/27/2020 for added header text and buttons		$signupurl = business_gravity_get_option( 'archive_button_signupurl' ); #added by rmorales 1/27/2020 for added header text and buttons		$compareurl = business_gravity_get_option( 'archive_button_compareurl' ); #added by rmorales 1/27/2020 for added header text and buttons		$disablesignup = business_gravity_get_option( 'disable_signup_button' ); #added by rmorales 1/27/2020 for added header text and buttons		$disablecompare = business_gravity_get_option( 'disable_compare_button' ); #added by rmorales 1/27/2020 for added header text and buttons
	}else{
	...
	$args = array(
		'title'       => $title,
		'description' => $description,		'subtitle' => $subtitle,   #added by rmorales 1/27/2020 for added header text and buttons		'signuptext' => $signuptext, #added by rmorales 1/27/2020 for added header text and buttons		'comparetext' => $comparetext, #added by rmorales 1/27/2020 for added header text and buttons		'signupurl' => $signupurl, #added by rmorales 1/27/2020 for added header text and buttons		'compareurl' => $compareurl #added by rmorales 1/27/2020 for added header text and buttons		'disablesignup' => $disablesignup, #added by rmorales 1/27/2020 for added header text and buttons		'disablecompare' => $disablecompare #added by rmorales 1/27/2020 for added header text and buttons
	);
